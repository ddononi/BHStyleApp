...
/**
 */
public class ReleaseDealListAdapter extends BaseAdapter {
	private final Context context;
	private List<StyleDAO> list;
	private LayoutInflater inflater = null;

	public ReleaseDealListAdapter(final Context context, final List<StyleDAO> list) {
		this.list = list;
	...
	synchronized public View getView(final int pos, final View convertView,
		...
		// 이미지 버튼의 포커스는 없애줘야 리스트 아이템에 포커싱을 줄수 있다.
	...
	class ViewHolder {
		...
		private TextView mjlqTv = null;				// 재고
