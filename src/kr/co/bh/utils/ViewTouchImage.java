...
public class ViewTouchImage extends ImageView implements OnTouchListener{
    ...
    public ViewTouchImage(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public ViewTouchImage(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewTouchImage(final Context context) {
        this(context, null);
    }
    ...
    private void matrixTurning(final Matrix matrix, final ImageView view){
        // 매트릭스 값
        float[] value = new float[9];
